...
class MyPath(object):
    ...
    def db_root_dir(database=''):
        db_names = {'cifar-10', 'stl-10', 'cifar-20', 'imagenet', 'imagenet_50', 'imagenet_100', 'imagenet_200', 'custom_data'}
        ...
        # Add path to custom data
        elif database == 'custom_data':
            return '/path/to/custom_data/'
